...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-S0TGLNkvxFLuORlacbatCbw6RP5Z+FjRiTz47dMK0GQ=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-r1S6Pkvd0gGK+svd/qO35JkPy1C8O5+mNf7OZm4Gu14=";
  }
else
