...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-6Gr9TFsuUiB7iuk+/n8D92WjYbV2Y22iRjErw0XGqlQ=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-cqSltnK/RTBLVlaXU7Oi+ZnAxC7EytrmOA124k0Gcaw=";
  }
else
