...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-DclQb2j4n/PYYK6JlFNu9hYRbDmWemE/K+4tJns7IeA=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-3fV6HzhNLnpILPbpuoZrkdH9QkFrHNEu2S3ZmVHIQUU=";
  }
else
