...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-Lq7QMaMiINs4QSOGfMOT+rGR0Otnt6wwIMg3kOwuUkM=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-Ui5ahFRHWOAjwJ0nJrCwCTG4+4IAKbik0DcdIKEskIs=";
  }
else
