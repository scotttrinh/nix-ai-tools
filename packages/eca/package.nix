...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-fR7XXitLtpHW7kXju3o5k+yzeHbR8ZAXQQgVebnblSk=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-m83MSNR/bGg0BQKkeKIfdpkDe0dfAXWHHh5dIpgh4/Q=";
  }
else
