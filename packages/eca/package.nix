...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-4Y0eZqXbsLK/vCVaNmUDF1ijw8XEmPnthmRSlKoLF9w=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-iFQUGYdcqrypG310wx8G4/CrGMP+LU2dkfKjMNF/exw=";
  }
else
