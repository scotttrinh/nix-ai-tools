...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-JBKWm5ZVTuxPau3jJzgPBJaaXxNpfs8uYb8C0yZ+e0s=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-oFbMZIaIBlzXcxQf07BY7omrMin0E//B/bkKqUpl4qk=";
  }
else
