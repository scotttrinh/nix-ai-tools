...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-ULaWgSO97V/jW8+QQQFIsIDi4H75YuuuyEZzZWAR1Lk=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-OJI+FQye+IgdHDTNyn+chGFfsx0isZt9TOKw4+poR1o=";
  }
else
