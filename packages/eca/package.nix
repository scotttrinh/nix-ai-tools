...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-HevoMVGRVSrZMxoLpBdRfddWt5JC9eKX5oP00JZRB9c=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-mkcvn4ca8xu8o/2/5tdQCz2MyHnW3EjGG4mqJUx+FQk=";
  }
else
