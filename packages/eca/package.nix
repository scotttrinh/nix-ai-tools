...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-KoGMQyAHl/+DeEVCe80b//PP8MckvY6cJ0MkNYRwong=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-UJpUdnLKVN7ilMDSJc3thqdawbp49K7beDIQfg/vtMA=";
  }
else
