...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-HnlGfQTpe5w7t8FXMjy4MroeWGciSNnS0PVJRefeyZQ=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-hztPUW3BLCnMk3imhUl1At7+hPok4q5PCwHlyXpNyEg=";
  }
else
