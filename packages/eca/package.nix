...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-EyORC8Hr7TPvaubvY70VmY/mueRbS5Fvd0yXUyJla3A=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-EAk7udoFAZKG5+FLV3/Zq+LzHafYz2rb+rW5w70bJhI=";
  }
else
