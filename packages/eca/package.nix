...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-b+TDz0qogpSdEdz6LyJVryl54kY5QVvXTbmSSkPjs2E=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-h9xnamvoVE8Pxp/T0Vs8c0oSW4oUhUxw5Hg/SSGhWf0=";
  }
else
