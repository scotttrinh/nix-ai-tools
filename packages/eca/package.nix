...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-XTuxzcchbTF5ug3wyvWNlUgyOEiSeui7pZQEmW3PKlc=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-ArFeZCahHl87CHWCulJ4Q7BvjXQyR0IAd9gXKJBhae4=";
  }
else
