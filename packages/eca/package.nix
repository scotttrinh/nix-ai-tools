...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-u2Rhb96/SA7NXcGs1m9SSexpStWV/R2t5ljsBj4TQ3Q=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-ySo1/bkxbn2GawVBsCRd/H/sQX5B+Ppx5hETl6drWb8=";
  }
else
