...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-a0itqDdEhDAsepJK2GrVu4PkLKC3K7UsPB9L1OE60yY=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-O7P3mz/geOvL4vHKDg0r6P9GtSdR3uujgKdT5bSjbj0=";
  }
else
