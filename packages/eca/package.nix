...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-/Rf1RjfuwCAhGw2ifmGgkqLCFVjTjig+3Uv1ZCCjHKA=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-YDf32buN0hy8oAnbsW/qxbtrdrtxfvGu0Dt4jT7CHgA=";
  }
else
