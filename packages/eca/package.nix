...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-Or6cgWmFFK1yCr/YrETfBhgMUHutFwd1NolpX03psCA=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-TJPloyexFPUdQb31eVKLte/W0EzXUXpm+e6KQ5PUBgo=";
  }
else
