...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-bP/U5Q0I/ZMu9VxmU+7wP1apmgaFPq0giVb9gCx86B8=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-NNlVmeGx4vl5pIejqG7REbrzTDDCDWrCdqW+oLxWOyc=";
  }
else
