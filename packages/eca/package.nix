...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-Fjj2neP52I9DJhaZI+NAWW0It/ukRLLyBTxgIO4oqIM=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-ECS5rHGh8Ehzm6D7FCXaC5xUq5A+AQ5sOZDr2CiokK4=";
  }
else
