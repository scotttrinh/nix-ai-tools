...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-jJxYwQVdwv/TIz6LikoLcmri8lAHsOfekHJABSe8pDE=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-AgmRabAxNhupRYUZXOnyLV1Swxd11V2Un7+rkzKNjgo=";
  }
else
