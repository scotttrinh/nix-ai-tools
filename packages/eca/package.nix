...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-ZDcJ3cUcErakGTlnm+xXBY5d0UT5lWjd5bbTSIG9zHc=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-KIm6yDjWNY85SRSR6ImMmyUt04ysLolbFndOoulo0IU=";
  }
else
