...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-Xr9P4OLms+/DTuefQBt6tP2PXj2zSDlyxGqxID3gjSU=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-cu9F4XNjYmvPhf+YflKH7M6Z8lPHHWNyv/CXC8M4cRg=";
  }
else
