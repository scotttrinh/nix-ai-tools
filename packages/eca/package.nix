...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-oD2+lTBSQRT7OmC1nP2M3Id0PCjNvZViVnUXVKEZvc0=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-xVohpCexo1EXve09QO2wMxn8C8Owib/LEA49negkx3A=";
  }
else
