...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-mN7O/fLjryLJJBQk1i+VE/tVsNj1z/NMO+2cmZ5bdiw=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-v2tXsLV9NfeRT0x5cCepDG+LXal3Oc2AV3wVtZUU6ms=";
  }
else
