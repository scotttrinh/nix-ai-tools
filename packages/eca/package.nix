...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-L0kYpQzlA4/nGJrvIeaXicFHjZhenRoSz6wQy++JFDo=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-jRCn402uunSvCyRn4vXpk850xKXht1igi/5HucsDR2k=";
  }
else
