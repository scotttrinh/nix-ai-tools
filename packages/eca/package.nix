...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-+JrcHpeOk45pyRkM2tEkij1QyVrmjMntIpNNC7MGCXw=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-UYG1Pbsdep8JcbgctfCngXF7dCnM9Hl42+5RkmnvzvA=";
  }
else
